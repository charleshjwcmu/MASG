...
Root_Development = "C:\\Users\\huang\\workspace\\MASG"
...
REPROCESS = TRUE # if TRUE, the CSI will be reprocessed and the database will be refreshed.
...
#Max_var=3
#source("./4.5_ModelSelectio n_MFA3Var.R")
